...
2. Install a dependency manager called npm
3. Run `npm install` on the command line interface to install the [project dependencies](package.json)
4. Run `npm run start` on the command line interface
5. Open monday.com and login to your account
6. Select your avatar on the left navigation bar, open the "Developers" section and select the "FakeCheck" app
7. Open the "Features" section and select the "Fact Check Analyzer" feature
8. Visit http://localhost:4040/status and under "command_line section" find the URL (this is the public URL of the app\*).
9. Open the "View setup" tab and paste the URL into the "Custom URL" field
10. Click the "Boards" button and choose one of the boards with some data in it
